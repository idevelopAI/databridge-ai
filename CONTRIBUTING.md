...
Use `./scripts/demo.sh` to verify the full local workflow without a provider key.
Recorded mode must remain deterministic and must not initialize a model client.
